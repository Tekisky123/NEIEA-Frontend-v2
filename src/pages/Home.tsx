...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#E5DED4] m-0 p-0">
      ...
      <div
        className="relative overflow-hidden mt-[40px] xl:mt-[115px] sm:mt-[35px] h-[calc(100vh-70px)] xl:h-[calc(200vh-140px)] sm:h-[calc(100vh-60px)] min-h-[300px] max-h-[800px] touch-pan-y"
      ...
      <div className="py-6 sm:py-8 lg:py-10 bg-white">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-4 sm:mb-6 lg:mb-8">
            <h2 className="text-[34px] leading-[1.4] font-[800] text-[#006b4d] mb-2 sm:mb-3 border-b-[4px] border-b-[#FFCC4E] pb-2">
              Vision and Mission
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 items-center">
            ...
            <div className="order-2 lg:order-1">
              <img
                ...
                className="w-full h-auto rounded-lg object-fit max-h-[400px] sm:max-h-[500px] lg:max-h-none"
              />
            </div>
      ...
      <div className="py-6 sm:py-6 lg:py-6 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-8 lg:mb-12">
            <h2 className="text-[34px] leading-[1.4] font-[800] text-[#006b4d] mb-3 sm:mb-4 border-b-[4px] border-b-[#FFCC4E] pb-2">
              Meet Our Leadership
            </h2>
            {/* <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-2">
              Visionary leaders dedicated to transforming education and empowering communities
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative">
                <img
                  ...
                  className="w-[600px] h-[480px] rounded-md shadow-lg object-fit max-h-[400px] sm:max-h-[500px] lg:max-h-none"
                />
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-[26px] leading-[1.4] font-[800] text-gray-900 mb-4">
                Javeed Mirza
              </h3>
        ...
        <div className="text-center mb-6 sm:mb-8 lg:mb-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h3 className="text-[26px] leading-[1.4] font-[800] text-gray-900 mb-3">
      ...
      {/* Statistics Section */}
      <div className="py-12 bg-gradient-to-r from-[#007AA4] via-[#007AA4] to-[#007AA4] text-white relative overflow-hidden">
        {/* Background Pattern */}
